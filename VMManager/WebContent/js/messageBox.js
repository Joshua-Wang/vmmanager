...
function ShowMessageBox(option)
{
    ...
    function SetEnabledStyle()
    {
        ...
        region = GetDocumentRegion();
         css ={width:region.width+"px",height:region.height+"px",left: 0+'px',top: 0 +'px'}
    ...
    function SetStyle(option)
    {
        ...
        left: ((region.width - MessageBox_width)/2)+'px',top: (document.documentElement.scrollTop+document.body.scrollTop+(region.height - MessageBox_height)/2)+'px'};
        ...
        {
            css.top=(document.documentElement.scrollTop+document.body.scrollTop+(region.height - MessageBox_height)/2)+'px'
        }
    ...
    function GetDocumentRegion()
    {
		...
		w = (de&&de.clientWidth) || document.body.clientWidth||self.innerWidth;
        h = document.body.scrollHeight||(de&&de.scrollHeight)|| self.innerHeight;
		//alert(de.scrollHeight+" "+document.body.scrollHeight+" "+self.innerHeight);
	...
	function GetClientRegion()
	{
		...
		de = document.documentElement;
		w = (de&&de.clientWidth) || document.body.clientWidth||self.innerWidth;
        h = (de&&de.clientHeight)||document.body.clientHeight||self.innerHeight;
		return {height:h,width:w};
	}
